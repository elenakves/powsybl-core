...
class SetTargetPFixedExtension implements DslTaskExtension {

    @Override
    void addToSpec(MetaClass tasksSpecMetaClass, List<ModificationTask> tasks, Binding binding) {
        tasksSpecMetaClass.setTargetPFixed = { String id, float consPuissEff ->
            tasks.add(new SetTargetPFixed(id, consPuissEff))
        }
    }
}
